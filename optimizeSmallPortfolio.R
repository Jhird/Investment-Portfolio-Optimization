...
returns <- getReturns(stocks, freq="day", start = "2014-01-01", end = "2015-09-10")
...
library(xlsx)
write.xlsx(returns$R, "C:/Users/Jahir/Documents/MATLAB/returnsSmallPortfolio.xlsx")